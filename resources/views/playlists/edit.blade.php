...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Edit Playlist</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="{{ route('playlists.update', $playlist) }}">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('playlists.show', $playlist) }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                    Cancel
                </a>
